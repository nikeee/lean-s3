...
import { SeaweedFSContainer } from "./SeaweedFSContainer.ts";

describe("seaweedfs", async () => {
	const s3 = await new SeaweedFSContainer().start();
	const region = "us-east-1";
	const bucket = "test-bucket-seaweedfs";
